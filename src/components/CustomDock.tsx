...
const DATA = {
  navbar: [
    ...
    { href: "/blogs", icon: BookIcon, label: "Blog" },
  ],
...
export function CustomDock() {
  ...
  return (
    <div className="fixed bottom-10 left-1/2 right-1/2 flex items-center justify-center">
      <div className="scale-[0.8] origin-bottom">
        {mounted && (<TooltipProvider>
          <Dock direction="middle" className="bg-white/90 backdrop-blur-sm shadow-lg rounded-xl dark:bg-black/90" >
